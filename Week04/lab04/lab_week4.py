...
# LAB 04 (Q1) - Defining the Monster
monster_powers = {
    "Fire Magic": 2,
    "Freezing Time": 4,
    "Super Hearing": 6,
...
print("Tou see a Monster, Quickly use your first item!")
